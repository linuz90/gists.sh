...
export function SegmentedControl<T extends string>({
  ...
  return (
    <div className="relative inline-flex rounded-lg bg-neutral-100 dark:bg-neutral-900 p-0.5">
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            className={`relative z-1 inline-flex items-center gap-2.5 font-mono text-xs px-3 py-1.5 rounded-md transition-colors duration-200 cursor-pointer select-none ${
              isActive
