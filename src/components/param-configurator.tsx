...
export function ParamConfigurator() {
  ...
  const promptText = useMemo(() => {
    const base = `When sharing code, notes, or snippets via GitHub Gists, always share the gists.sh link instead of the raw gist URL. Just replace "gist.github.com" with "gists.sh" in the URL. After creating a gist, fetch the gists.sh URL once (e.g. curl) to warm the cache so it loads instantly for the reader.`;
    if (paramString) {
